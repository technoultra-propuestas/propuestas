    ...
    <section className="py-32 bg-gradient-to-br from-brand to-[#e05d00] text-white">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <motion.div
           ...
           className="bg-white/10 backdrop-blur-md border border-white/20 p-12 rounded-[3rem] shadow-2xl"
        >
          <h2 className="text-sm font-bold tracking-[0.2em] uppercase mb-8 text-white/90">Inversión Estimada</h2>
          <div className="flex items-end justify-center gap-3 mb-8">
             <span className="text-5xl md:text-6xl font-light text-white/80 leading-none">$</span>
             <span className="text-7xl md:text-9xl font-black tracking-tighter leading-none">{price.toLocaleString()}</span>
             <span className="text-3xl font-bold mb-2 text-white/90">COP</span>
          </div>
